...
var uiobject_danx=text("单选题 (10分)").findOnce();  
var uiobject_danx1=text("单选题").findOnce();    

if(uiobject_danx){        
    log(uiobject_danx)
    funs.控件_遍历_返回数组(uiobject_danx.parent().parent(),arr)
    }else if(uiobject_danx1){  
        log(uiobject_danx1)
        funs.控件_遍历_返回数组(uiobject_danx1.parent().parent(),arr)
        }else{
        log('找不到控件')
}
